        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-10 leading-relaxed font-medium">
              ...
              tradition, and meaningful relationships. Connect with someone who shares your spirit.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 tracking-tight mb-4">
              Built for <span className="text-rose-600">Zimbabwean</span> Values
            </h2>
            <p className="text-xl text-gray-600 font-medium">Why thousands of Christians choose Lifestyle Connect.</p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-8 tracking-tight leading-tight">
            Zimbabwe's Christians <br/>are waiting for <span className="text-rose-600 underline">you.</span>
          </h2>
          <button
            onClick={onGetStarted}
